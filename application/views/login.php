...
<head>
	...
	<title>Login</title>
	<link href="<?php echo base_url('theme/css/app.css') ?>" rel="stylesheet">
							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center">
										<img src="<?php echo base_url('theme/img/avatars/avatar.jpg') ?>" alt="Charles Hall" class="img-fluid rounded-circle" width="132" height="132" />
									</div>
